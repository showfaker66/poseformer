...
def prep_image(img, inp_dim):
    ...
    img = (letterbox_image(orig_im, (inp_dim, inp_dim)))  # 图像从 720, 1280, 3 -> 416, 416, 3
    img_ = img[:, :, ::-1].transpose((2, 0, 1)).copy()  # 3, 416, 416
    img_ = torch.from_numpy(img_).float().div(255.0).unsqueeze(0) # 1, 3, 416, 416
